...
let autoTween = function(){
	...
	.to('.auto', .5, {rotation: '70deg', top: '180px', left: '405px'})
	.to('.auto', 1, {top: '230px', left: '420px'})
	.to('.auto', 1, {rotation: '90deg', top: '225px', left: '420px'})
	.to('.auto', .5, {top: '248px', ease: 'sine'})
	.to('.auto', 1, {top: '300px', ease: 'sine'})
	.to('.auto', 1, {rotation: '65deg', top: '380px', left: '462px', ease: 'sine'})
	.to('.auto', 1, {top: '480px', left: '495px', ease: 'sine'})
